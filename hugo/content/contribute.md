...
The [tickets are labeled with `support`](https://github.com/mumble-voip/mumble/issues?q=is%3Aopen+is%3Aissue+label%3Asupport). Our [Matrix room](https://matrix.to/#/#mumble:matrix.org) and the [/r/mumble subreddit](https://www.reddit.com/r/mumble/new/) also regularly receive support requests.
