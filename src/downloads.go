...
func setupDownloadsStable(mux *http.ServeMux) {
	stable := map[string]string{
		"windows-32":          "https://github.com/mumble-voip/mumble/releases/download/1.3.0-rc2/mumble-1.3.0-rc2.msi",
		"windows-64":          "https://github.com/mumble-voip/mumble/releases/download/1.3.0-rc2/mumble-1.3.0-rc2.winx64.msi",
		"osx":                 "https://github.com/mumble-voip/mumble/releases/download/1.3.0-rc2/Mumble-1.3.0-rc2.dmg",
		...
		"linux-static-server": "https://github.com/mumble-voip/mumble/releases/download/1.3.0-rc2/murmur-static_x86-1.3.0-rc2.tar.bz2",
		"osx-static-server":   "https://github.com/mumble-voip/mumble/releases/download/1.3.0-rc2/Murmur-OSX-Static-1.3.0-rc2.tar.bz2",
	}
