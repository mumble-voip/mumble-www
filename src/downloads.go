...
func setupDownloadsStable(mux *http.ServeMux) {
	stable := map[string]string{
		...
		"osx":                 "https://github.com/mumble-voip/mumble/releases/download/1.3.4/Mumble-1.3.4.dmg",
		...
		"osx-static-server":   "https://github.com/mumble-voip/mumble/releases/download/1.3.4/Murmur-OSX-Static-1.3.4.tar.bz2",
	}
